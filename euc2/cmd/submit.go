...
var submitCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, _ []string) {
		...
		cmd.Println("Submission created at:", submissionPath)
	},
}
...
func submitExercise(strategy submitStrategy, orgID string, studentID string) (string, error) {
	...
	case "remote":
		return "", fmt.Errorf("remote submit is not implemented")
	default:
...
func init() {
	...
	submitCmd.Flags().StringVarP(
		...
		"",
		"Submit using the remote strategy and the provided destination path",
	)
